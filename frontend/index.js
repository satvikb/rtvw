...
function Game() {
  ...
  function submitGuess() {
    ...
    if(!correctGuess) {
      ...
      {
        gameState.innerText = "Your turn!";
      }
      else
      {
        gameState.innerText = "Opponent's turn!";
      }
      return;
    }
  ...
  function startGame(number, word, startingPlayer) {
    gameBoard.clear();
    removeListseners();
    keyboard.clear();
...
function handleInit(number, word, startingPlayer)
{
  playerNumber = number;
  theGame.startGame(number, word, startingPlayer);
